      ...
      <div className="container-xl text-center">
        <FadeIn>
          <h2 className="font-heading text-3xl sm:text-4xl text-white font-bold mb-4">
            Ready to Protect Your Mormon Lake Property?
          </h2>
          <p className="font-body text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Get a comprehensive insurance quote in minutes. Same-day coverage, seasonal vacancy protection, and competitive rates from 12+ carriers.
          </p>
