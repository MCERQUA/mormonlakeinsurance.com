      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-forest-green rounded-md flex items-center justify-center">
                <span className="text-white font-heading font-bold text-sm">ML</span>
              </div>
              <span className="font-heading font-bold text-white text-lg">
                Mormon Lake<span className="text-ember-orange">Insurance</span>
              </span>
            </div>
            <p className="font-body text-sm text-white/70 leading-relaxed mb-4">
              Independent insurance agency serving Mormon Lake, AZ and Northern Arizona's mountain communities since 2005. Cabin, home, auto, and recreational vehicle specialists.
            </p>
          ...
          <div>
            ...
            <p className="font-body text-sm text-white/70 mb-4">Free quotes for cabins, homes, auto, and recreational vehicles. Call or fill out our quick quote form.</p>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-white/50">
            &copy; {new Date().getFullYear()} {SITE.name}. NPN #{SITE.npn}. Licensed in all 50 states.
          </p>
