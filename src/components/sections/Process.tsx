...
const STEPS = [
  { icon: ClipboardList, step: "01", title: "Tell Us About Your Property", desc: "Share details about your cabin, home, or vehicle — location, construction type, occupancy pattern, and coverage needs." },
  { icon: Search, step: "02", title: "Review Your Quote", desc: "We shop 12+ carriers and present competitive options tailored to your Mormon Lake area property and risk profile." },
  { icon: CheckCircle, step: "03", title: "Get Covered Today", desc: "Bind your policy and receive documentation same-day. We're available to answer questions and adjust coverage anytime." },
];
        ...
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <p className="font-body text-muted max-w-xl mx-auto">
              From initial quote to bound coverage — our process is designed for property owners who need it done right the first time.
            </p>
          </div>
        </FadeIn>
