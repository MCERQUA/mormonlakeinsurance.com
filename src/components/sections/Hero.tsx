        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh] pb-12">
          <div className="py-12">
            <FadeIn>
              <div className="inline-flex items-center gap-2 bg-ember-orange/10 border border-ember-orange/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="font-body text-sm font-bold text-ember-orange">Mormon Lake, AZ Specialists</span>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.05}>
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-bark font-bold leading-tight mb-6">
                Insurance for{" "}
                <span className="text-forest-green">Mormon Lake</span>{" "}
                Cabins & Homes
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <p className="font-body text-lg text-muted leading-relaxed mb-8 max-w-lg">
                Cabin insurance, auto coverage, recreational vehicles, and property protection for the Mormon Lake community and Northern Arizona's mountain region. Free quotes from 12+ carriers.
              </p>
            </FadeIn>
          ...
          <FadeIn delay={0.1} direction="left" className="relative h-[500px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur rounded-xl p-4 shadow-lg">
              <p className="font-body text-xs text-muted mb-1">Most Popular Coverage</p>
              <p className="font-heading font-bold text-bark text-sm">Cabin + Auto + Recreational Vehicle</p>
              <p className="font-body text-xs text-forest-green font-bold mt-1">Bundle & Save Up to 25%</p>
            </div>
          </FadeIn>
        </div>
      </div>
