...
import { Shield, Home, Car, Truck, Building2, Trees, ArrowRight } from "lucide-react";
      ...
      <div className="container-xl">
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">Insurance for the Mormon Lake Community</h2>
            <p className="font-body text-muted max-w-2xl mx-auto">
              From mountain cabins to recreational vehicles, we provide specialized insurance coverage designed for the unique risks of the Mormon Lake area.
            </p>
          </div>
        </FadeIn>
