        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <p className="font-body text-white/80 text-lg max-w-xl">Get in touch with our Mormon Lake insurance specialists. Same-day response, same-day quotes.</p>
            </FadeIn>
          </div>
        </section>
              ...
              <FadeIn>
                {submitted ? (
                  <div className="bg-white rounded-2xl border border-border p-10 text-center">
                    ...
                    <p className="font-body text-muted mb-6">We will respond within a few hours during business hours (Mon-Fri 8am-5pm MST).</p>
              ...
              <div className="space-y-6">
                ...
                <FadeIn direction="left" delay={0.1}>
                  <div className="bg-ember-orange/10 border border-ember-orange/20 rounded-2xl p-6">
                    <p className="font-body text-sm font-bold text-ember-orange mb-2">Need a Quick Quote?</p>
                    <p className="font-body text-sm text-bark mb-3">We provide same-day insurance quotes for cabins, homes, and recreational vehicles. Call us directly for fastest service.</p>
