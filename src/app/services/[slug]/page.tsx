...
export async function generateMetadata({
  ...
  if (!service) return {};
  return {
    title: `${service.title} in Mormon Lake, AZ`,
              ...
              <aside className="space-y-6">
                <FadeIn direction="left">
                  <div className="bg-forest-green rounded-2xl p-7 sticky top-24">
                    ...
                    <p className="font-body text-white/70 text-sm mb-6">Same-day quotes for Mormon Lake area properties and vehicles. Coverage tailored to your mountain risks.</p>
