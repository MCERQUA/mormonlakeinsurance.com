...
import { ArrowRight, Shield, Home, Car, Truck, Building2, Trees } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Mormon Lake Insurance Services",
  description: `Complete insurance coverage for Mormon Lake, AZ — cabin, home, auto, recreational vehicle, vacant property, and outdoor recreation business insurance. ${SITE.statesLicensed}.`,
};

const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  Shield, Home, Car, Truck, Building2, Trees,
};
        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Mormon Lake Insurance Services</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Every policy a Mormon Lake property owner needs — from cabin insurance to recreational vehicles, all from specialists who know the mountain.
              </p>
            </FadeIn>
          </div>
        </section>
